...
import (
	...
	//util "k8s.io/kubernetes/pkg/volume/util"
...
// func (plugin *qcloudDiskPlugin) GetVolumeLimits() (map[string]int64, error) {
// 	volumeLimits := map[string]int64{
// 		util.QcloudCbsVolumeLimitKey: util.DefaultMaxQcloudCbsVolumes,
// 	}
...
// if cloud.ProviderName() != qcloud.ProviderName {
// 	return nil, fmt.Errorf("Expected qcloud, found %s", cloud.ProviderName())
// }

// qcloud, err := getCloudProvider(cloud)
// if err != nil {
// 	return nil, err
// }
// maxAttachLimit, err := qcloud.GetMaxAttachLimit()
// if err != nil {
// 	return nil, err
// }

// if maxAttachLimit > 0 {
// 	volumeLimits[util.QcloudCbsVolumeLimitKey] = int64(maxAttachLimit) - 2
// }

// 	return volumeLimits, nil
// }

// func (plugin *qcloudDiskPlugin) VolumeLimitKey(spec *volume.Spec) string {
// 	return util.QcloudCbsVolumeLimitKey
// }
